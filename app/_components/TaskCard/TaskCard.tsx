...
const TaskCard: React.FC<TaskCardProps> = ({
    ...
    // console.log(task, process.env, process.env.NEXT_PUBLIC_ASSETS_PATH);
            ...
            {solution ? (
                <div className={styles.solutionContent}>
                    ...
                    <div className={styles.solutionDescription}>
                        ...
                        <p className="text fz20">
                            2. Составляйте уникальные отклики, которые покажут
                            вашу компетентность и заинтересованность в проекте
                        </p>
                        <p className="text fz20">
                    ...
                    <div className={styles.solution}>
                        ...
                        <div className={styles.underdescription}>
                            ...
                            >
                                {0} из {maxLength} символов (минимум {minLength}
                                )
                            </p>
                        </div>
